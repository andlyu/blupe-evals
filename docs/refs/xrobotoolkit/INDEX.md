# xrobotoolkit — XRoboToolkit-Teleop-Sample-Python reference

Vendored guidance for the teleop framework we depend on. Read before changing robot configs
or assets.
...
Not installed on this Mac — the framework lives on the Orin. Read the repo, not a local venv.
